...
contract Strategy_Scream is Strategy {
    ...
    constructor(
        ...
        buybackRouterAddress = _addresses[3];
        vaultBuyBackAddress = _addresses[4];
    ...
    function setBuybackRouterAddress(address _buybackRouterAddress) public override {}
}
