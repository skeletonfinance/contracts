...
contract TimelockController is AccessControl, ReentrancyGuard {
    ...
    function executeSet(
        ...
        _beforeCall(predecessor);
        INativeFarm(_nativefarmAddress).set(_pid, _allocPoint);
        _afterCall(id);
    }
    ...
    function add(
        ...
        INativeFarm(_nativefarmAddress).add(0, _want, _strat); // allocPoint = 0. Schedule set (timelocked) to increase allocPoint.
    }
